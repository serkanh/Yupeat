...
class PayPalPaymentsForm(forms.Form):
    ...
    def render(self):
        return mark_safe(u"""
            ...
            %s
            <button id="pp_buy_now" name="submit" alt="Buy it Now"></button>
    ...
    def render_disabled(self):
        return mark_safe(u"""
            <form action="%s" method="post">
            %s
            <button id="pp_disabled" name="submit" disabled="disabled" alt="Buy it Now"></button>
        </form>""" % (self.get_endpoint(), self.as_p()))
    ...
    def sandbox(self):
        ...
        """ % (self.get_sandbox_endpoint(), self.as_p()))
